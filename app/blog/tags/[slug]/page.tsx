...
export default function TagSlug({
  ...
  const postSortedByTags = postSorted.filter((post) => post.tags?.includes(decodedTag));
    ...
    <>
      <div className="grid grid-cols-9">
        ...
        <div className="col-span-7 p-6 mt-2 space-y-4">
            <Link href="/blog" className="flex flex-col w-fit justify-left rounded-2xl px-2 py-1 transition-all hover:bg-accent hover:drop-shadow-normal active:scale-95">
